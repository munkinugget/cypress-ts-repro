...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "dependencyTreeRoots": [\
      {\
        "name": "cypress-ts-repro",\
        "reference": "workspace:."\
      },\
      {\
        "name": "@cypress-ts-repro/cypress-tests",\
        "reference": "workspace:packages/cypress-tests"\
      }\
    ],\
    "enableTopLevelFallback": true,\
    "ignorePatternData": "(^(?:\\\\.yarn\\\\/sdks(?:\\\\/(?!\\\\.{1,2}(?:\\\\/|$))(?:(?:(?!(?:^|\\\\/)\\\\.{1,2}(?:\\\\/|$)).)*?)|$))$)",\
    "fallbackExclusionList": [\
      ["@cypress-ts-repro/cypress-tests", ["workspace:packages/cypress-tests"]],\
      ["cypress-ts-repro", ["workspace:."]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
      ...
      ["@cypress-ts-repro/cypress-tests", [\
        ["workspace:packages/cypress-tests", {\
          "packageLocation": "./packages/cypress-tests/",\
          "packageDependencies": [\
            ["@cypress-ts-repro/cypress-tests", "workspace:packages/cypress-tests"],\
